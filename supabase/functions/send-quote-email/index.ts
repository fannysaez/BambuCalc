...
<head><meta charset="UTF-8"><style>
  ...
  .header { background: linear-gradient(135deg, #2e9cab, #3fb2bf); padding: 28px 32px; color: #fff; }
  ...
  .total-value { font-weight: 800; color: #2e9cab; font-size: 18px; }
...
<div class="wrapper">
  <div class="header">
    <h1>🖨️ Nouveau devis BambuCalc</h1>
  ...
  <div class="footer">BambuCalc — fanny.saez.0486@gmail.com</div>
</div>
</body>
</html>`
...
<div class="wrapper">
  <div class="header">
    <h1>🖨️ Votre devis BambuCalc</h1>
    <p>Impression 3D professionnelle</p>
  </div>
  <div class="body">
    <p class="intro">Bonjour ${clientDisplay},<br/>Voici le récapitulatif de votre devis. N'hésitez pas à nous contacter pour toute question.</p>
    <span class="badge">${quote.quote_number ?? '—'}</span>
  ...
  <div class="footer">
    BambuCalc — Fanny Saez — fanny.saez.0486@gmail.com<br/>
    143 bis Boulevard Lafayette, 63000 Clermont-Ferrand
  </div>
</div>
</body>
</html>`
      ...
      emails.push(
        fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            ...
            subject: `Votre devis BambuCalc — ${quote.quote_number ?? ''} — ${quote.project_name ?? ''}`,
            html: clientHtml,
          }),
        }),
      )
